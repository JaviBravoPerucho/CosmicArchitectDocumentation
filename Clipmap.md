...
Al alejarte lo suficiente del planeta, la semiesfera no requiere tanta resolución para notar el detalle por lo que se convierte en una malla estática de una esfera. Combinando que al acercarse la semiesfera siempre sigue a la cámara y que al alejarse se ve una malla esférica, siempre tiene apariencia de planeta y se mejora mucho el rendimiento.
...
* **Min Triangle Size:** Tamaño mínimo del triángulo al que puede llegar el nivel de más detalle.
