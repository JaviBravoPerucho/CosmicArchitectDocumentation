...
Este componente permite que el planeta tenga un océano. El océano consiste en una malla estática de esfera con material, tamaño y resolución configurable. A esta malla no se le puede aplicar ruido para el relieve al no ser un clipmap, las zonas de océano se consideran planas.
...
<figure><img src=".gitbook/assets/ocean_material.jpg" alt=""><figcaption></figcaption></figure>
